...
insert into analyses (id, type, owner_id, hidden_info, created_time, updated_time)
values (2, 0, 2, 'test hidden info 3', current_timestamp, current_timestamp);

insert into analyses (id, type, owner_id, hidden_info, created_time, updated_time)
values (3, 1, 3, 'test hidden info 2', current_timestamp, current_timestamp);

insert into analyses_viewers(id, analyses_id, viewers_id)
values (1,2,3);
insert into analyses_viewers(id, analyses_id, viewers_id)
values (2,3,2);