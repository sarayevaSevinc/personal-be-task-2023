...
public class AnalysisControllerTest {
  ...
  public void addAnalysis_success_returnAnalysisResponse() {
    ...
    AnalysisRequestDto analysisRequestDto = AnalysisRequestDto.builder().type("FIRST")
    ...
    assertEquals(analysisRequestDto.getType(), responseEntity.getBody().getType().name());
  ...
  public void addAnalysis_error_throwInsufficientBudget() {
    ...
    AnalysisRequestDto analysisRequestDto = AnalysisRequestDto.builder().type("SECOND")
