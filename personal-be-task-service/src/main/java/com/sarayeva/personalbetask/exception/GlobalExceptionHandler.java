...
import com.sarayeva.personalbetask.dto.ErrorResponseDto;
...
public class GlobalExceptionHandler {
  ...
  @ExceptionHandler(value = {AnalysisTypeValidationException.class})
  @ResponseStatus(value = HttpStatus.BAD_REQUEST)
  protected ErrorResponseDto handleAnalysisTypeValidationException(
      AnalysisTypeValidationException ex) {
    return ErrorResponseDto.builder()
        .code(HttpStatus.BAD_REQUEST.value())
        .message(ex.getMessage())
        .build();
