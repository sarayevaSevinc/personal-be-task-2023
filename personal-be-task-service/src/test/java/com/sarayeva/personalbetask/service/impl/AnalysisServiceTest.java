...
import static com.sarayeva.personalbetask.util.Utility.createAnalysis;
import static com.sarayeva.personalbetask.util.Utility.createAnalysisRequestDto;
import static com.sarayeva.personalbetask.util.Utility.createAnalysisResponseDto;
...
class AnalysisServiceTest {
  ...
  void saveAnalysis_success_returnAnalysis() {
    ...
    // verify
    Assertions.assertEquals(analysisRequestDto.getType(), result.getType().name());
